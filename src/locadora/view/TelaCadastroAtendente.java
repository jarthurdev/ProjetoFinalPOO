...
public class TelaCadastroAtendente extends JDialog {
    ...
    public TelaCadastroAtendente(JFrame parent) {
        ...
        botaoCadastrar.addActionListener(e -> cadastrarAtendente());
    ...
    private void cadastrarAtendente() {
        ...
        try {
            funcionarioController.cadastrarAtendente(login, senha, "Atendente");
            ...
            JOptionPane.showMessageDialog(this, "Erro ao cadastrar atendente.", "Erro", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    }
}
